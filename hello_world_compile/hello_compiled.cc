...
// Generated on: 09.03.2022 17:35:18
...
const TfArray<1, float> quant0_scale = { 1, { 0.0084779364988207817, } };
...
const ALIGN(8) int32_t tensor_data3[16] = { 0, 2900, -2544, 0, 3103, 0, 0, 1438, 0, 0, 8420, 0, 1939, -2831, -3994, 0, };
...
const TfArray<1, float> quant4_scale = { 1, { 0.01194394938647747, } };
...
const ALIGN(8) int8_t tensor_data5[16*16] = { 
  ...
  -15, 28, -37, 26, 26, 32, -27, 25, -11, -1, -105, 11, 0, 0, -50, -33, 
  13, -9, 21, -28, -19, -4, 13, -23, -5, -20, 92, -4, 29, 2, 88, -29, 
  -32, -12, 21, -20, -7, 0, 19, 5, -20, 12, 28, 20, 12, -23, 10, -12, 
  24, 0, -41, 5, 39, 2, 21, -23, -22, 2, -101, 0, 12, -6, -23, -22, 
  ...
  13, -15, 10, 25, 26, -6, -32, 25, 30, 19, 55, 28, 18, -20, 58, 12, 
  -74, -53, -26, 19, -9, -21, -15, 5, 27, -6, 25, -27, -20, -49, 12, -12, 
};
const TfArray<2, int> tensor_dimension5 = { 2, { 16,16 } };
const TfArray<1, float> quant5_scale = { 1, { 0.012777457945048809, } };
const TfArray<1, int> quant5_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant5 = { (TfLiteFloatArray*)&quant5_scale, (TfLiteIntArray*)&quant5_zero, 0 };
const ALIGN(8) int32_t tensor_data6[16] = { 0, 1275, 2721, 1640, -1988, 0, 2797, -2003, 1255, 2596, -442, 1223, 0, -2143, -1753, 1435, };
const TfArray<1, int> tensor_dimension6 = { 1, { 16 } };
const TfArray<1, float> quant6_scale = { 1, { 0.00015261331282090396, } };
const TfArray<1, int> quant6_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant6 = { (TfLiteFloatArray*)&quant6_scale, (TfLiteIntArray*)&quant6_zero, 0 };
const TfArray<2, int> tensor_dimension7 = { 2, { 1,16 } };
const TfArray<1, float> quant7_scale = { 1, { 0.0058438042178750038, } };
const TfArray<1, int> quant7_zero = { 1, { -128 } };
const TfLiteAffineQuantization quant7 = { (TfLiteFloatArray*)&quant7_scale, (TfLiteIntArray*)&quant7_zero, 0 };
const ALIGN(8) int8_t tensor_data8[1*16] = { 
  33, -94, -116, -55, 95, 29, -50, 65, -97, -51, 32, -80, -33, 83, 47, -127, 
};
const TfArray<2, int> tensor_dimension8 = { 2, { 1,16 } };
const TfArray<1, float> quant8_scale = { 1, { 0.008489939384162426, } };
const TfArray<1, int> quant8_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant8 = { (TfLiteFloatArray*)&quant8_scale, (TfLiteIntArray*)&quant8_zero, 0 };
const ALIGN(4) int32_t tensor_data9[1] = { -4368, };
const TfArray<1, int> tensor_dimension9 = { 1, { 1 } };
const TfArray<1, float> quant9_scale = { 1, { 4.961354352417402e-05, } };
